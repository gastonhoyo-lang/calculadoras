...
import { l as renderComponent, r as renderTemplate, h as addAttribute, m as maybeRenderHead, u as unescapeHTML } from "./worker-entry_D59mRXJw.mjs";
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const displayTitle = info.h1 || info.titulo;
  const seoTitle = `${displayTitle} | Resultado Exacto (2026)`;
  const seoDescription = `Calculá gratis: ${displayTitle}. El resultado es ${info.resultado}. Herramienta rápida, precisa y fácil de usar en Chieffin.`;
  const jsonLd = {

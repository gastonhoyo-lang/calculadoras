...
import { A as AstroError, I as InvalidComponentArgs, c as createRenderInstruction, r as renderTemplate, u as unescapeHTML, a as addAttribute, m as maybeRenderHead, b as renderComponent, d as renderSlot, e as renderHead } from "./worker-entry_D044QTxt.mjs";
...
const $$FAQ = createComponent(($$result, $$props, $$slots) => {
  ...
  const info = dataFaqs[id];
  if (!info) return null;
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<section class="max-w-4xl mx-auto px-4 mt-20 mb-20"> <div class="h-px bg-slate-200 w-full mb-16"></div> <h2 class="text-3xl font-black text-slate-900 mb-8 text-center">Preguntas Frecuentes</h2> <div class="max-w-3xl mx-auto space-y-4"> ', ' </div> <div class="mt-12 flex flex-wrap justify-center gap-3"> ', ' </div> </section> <script type="application/ld+json">', "<\/script>"])), maybeRenderHead(), info.faqs.map((faq) => renderTemplate`<details class="group bg-white border border-slate-200 rounded-2xl p-6 transition-all hover:border-blue-200 shadow-sm"> <summary class="flex items-center justify-between cursor-pointer list-none font-bold text-slate-800 text-lg"> ${faq.q} <span class="text-blue-600 transition group-open:rotate-180"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path> </svg> </span> </summary> <p class="mt-4 text-slate-600 leading-relaxed">${faq.a}</p> </details>`), info.relacionados.map((link) => renderTemplate`<a${addAttribute(link.link, "href")} class="text-sm font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-full hover:bg-blue-100 transition"> ${link.nombre} </a>`), unescapeHTML(JSON.stringify({
...
}, "C:/proyectos/seo-tools/src/components/FAQ.astro", void 0);
const navigation = [
  {
    name: "Finanzas",
    href: "/finanzas",
    ...
    links: [
      ...
      { name: "Préstamos", href: "/finanzas/prestamo" },
      { name: "Aguinaldo", href: "/finanzas/aguinaldo" },
      { name: "Dólar Tarjeta", href: "/finanzas/dolar-tarjeta" },
      { name: "Indemnización", href: "/finanzas/indemnizacion" }
    ]
  },
  {
    name: "Hogar",
    ...
    links: [
      ...
      { name: "Hormigón", href: "/hogar/hormigon" },
      { name: "Frigorías Aire", href: "/hogar/aire-acondicionado" },
      { name: "Consumo Eléctrico", href: "/hogar/consumo-electrico" },
      { name: "Metros Cuadrados", href: "/hogar/metros-cuadrados" }
    ]
  },
  {
    name: "Matemática",
    ...
    links: [
      ...
      { name: "Círculo", href: "/matematica/circulo" },
      { name: "Área Triángulo", href: "/matematica/triangulo" },
      { name: "Fracciones", href: "/utiles/fracciones" }
      // Mapeado a matemática
    ]
  },
  {
    name: "Negocios",
    links: [
      ...
      { name: "Precio de Venta", href: "/negocios/precio-venta" },
      { name: "ROI", href: "/negocios/roi" },
      { name: "Tarifa Freelance", href: "/negocios/tarifa-freelance" }
    ]
  },
  {
    name: "Salud",
    ...
    links: [
      ...
      { name: "Agua Diaria", href: "/salud/agua" },
      { name: "Embarazo", href: "/salud/embarazo" },
      { name: "Macros Keto", href: "/salud/keto" },
      { name: "Dejar de Fumar", href: "/salud/dejar-de-fumar" }
    ]
  },
  {
    name: "Útiles",
    ...
    links: [
      ...
      { name: "Días Hábiles", href: "/utiles/dias-habiles" },
      { name: "Combustible", href: "/utiles/combustible" },
      { name: "Edad Mascotas", href: "/utiles/edad-mascotas" }
    ]
  },
  {
    name: "Varios",
...
const $$MenuMovil = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<button id="openMobileMenu" class="lg:hidden p-2 text-slate-600 hover:text-blue-600 transition"> <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path> </svg> </button> <div id="mobileMenu" class="fixed inset-0 z-[100] invisible opacity-0 transition-all duration-300"> <div id="closeMobileMenu" class="absolute inset-0 bg-slate-900/60 backdrop-blur-sm"></div> <div class="absolute right-0 top-0 h-full w-[80%] max-w-sm bg-white shadow-2xl flex flex-col translate-x-full transition-transform duration-300" id="mobileMenuPanel"> <div class="p-4 border-b flex items-center justify-between"> <span class="font-black text-blue-600">MENÚ</span> <button id="closeMobileMenuBtn" class="p-2 text-slate-400"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path> </svg> </button> </div> <div class="flex-1 overflow-y-auto p-4"> ${navigation.map((category) => renderTemplate`<div class="mb-6"> <h3 class="text-xs font-black text-slate-400 uppercase tracking-widest mb-3"> ${category.name} </h3> <div class="grid grid-cols-1 gap-2"> ${category.links.map((link) => renderTemplate`<a${addAttribute(link.href, "href")} class="block py-2 text-slate-700 font-bold hover:text-blue-600 border-b border-slate-50"> ${link.name} </a>`)} </div> </div>`)} </div> </div> </div> ${renderScript($$result, "C:/proyectos/seo-tools/src/components/MenuMovil.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/proyectos/seo-tools/src/components/MenuMovil.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const {
    title,
    description = "Calculadoras financieras gratuitas: Simulá préstamos, calculá interés compuesto y tomá mejores decisiones con Chieffin."
  } = Astro2.props;
  new URL(Astro2.url.pathname, "https://chieffin.com");
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', '><link rel="canonical"', "><title>", ' | Chieffin</title><meta name="title"', '><meta name="description"', '><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="https://chieffin.com/og-image.jpg"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image" content="https://chieffin.com/og-image.jpg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#2563eb"><link rel="apple-touch-icon" href="/icon-192.png"><script type="application/ld+json">', '<\/script><script>\n      if ("serviceWorker" in navigator) {\n        window.addEventListener("load", () => {\n          navigator.serviceWorker.register("/sw.js");\n        });\n      }\n    <\/script>', '</head> <body class="bg-slate-50 text-slate-900 font-sans antialiased"> <header class="bg-white border-b border-slate-200 sticky top-0 z-50"> <nav class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4"> <a href="/" class="text-2xl font-black tracking-tight text-blue-600 shrink-0">\nCHIEFFIN<span class="text-slate-400">.com</span> </a> <div class="hidden lg:flex gap-4 text-sm font-medium text-slate-600"> ', ' </div> <div class="flex items-center gap-2"> <button id="favBtn" class="bg-slate-900 text-white px-3 py-2 sm:px-4 rounded-lg text-sm font-bold hover:bg-slate-800 transition flex items-center gap-2 shrink-0"> <span id="favIcon">⭐</span> <span class="hidden sm:inline">Favoritos</span> </button> ', ' </div> </nav> </header> <main class="min-h-[calc(100vh-160px)]"> ', " ", ' </main> <footer class="bg-white border-t border-slate-200 py-12 mt-20"></footer> <script>\n      let deferredPrompt;\n      const favBtn = document.getElementById("favBtn");\n      const favIcon = document.getElementById("favIcon");\n\n      const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);\n      const isiOS = /iPad|iPhone|iPod/.test(navigator.userAgent);\n\n      // --- Lógica de Instalación PWA ---\n      window.addEventListener("beforeinstallprompt", (e) => {\n        e.preventDefault();\n        deferredPrompt = e;\n        if (favBtn && favIcon) {\n          favIcon.textContent = "📲";\n          favBtn.innerHTML = "<span>📲</span> Instalar App";\n          favBtn.classList.replace("bg-slate-900", "bg-blue-600");\n        }\n      });\n\n      favBtn?.addEventListener("click", async () => {\n        if (deferredPrompt) {\n          deferredPrompt.prompt();\n          await deferredPrompt.userChoice;\n          deferredPrompt = null;\n          return;\n        }\n\n        if (isiOS) {\n          alert(\n            \'Para instalar en tu iPhone:\\n\\n1. Toca el botón "Compartir".\\n2. Selecciona "Agregar a inicio".\',\n          );\n          return;\n        }\n\n        const isMac = navigator.platform.toUpperCase().indexOf("MAC") >= 0;\n        alert(\n          isMobile\n            ? \'¡Guardanos en tu inicio! Tocá los tres puntos (⋮) y seleccioná "Instalar aplicación".\'\n            : `¡Guardanos en favoritos! Presioná ${isMac ? "Cmd + D" : "Ctrl + D"}.`,\n        );\n      });\n\n      // --- Lógica del Botón de WhatsApp Automático ---\n      document.addEventListener("click", (e) => {\n        // Detectamos si el click fue en un botón de calcular\n        if (\n          e.target.innerText?.toLowerCase().includes("calcular") ||\n          e.target\n            .closest("button")\n            ?.innerText.toLowerCase()\n            .includes("calcular")\n        ) {\n          setTimeout(() => {\n            const resultBoxes = document.querySelectorAll(\n              \'[id*="res"], [id*="Result"], .animate-in\',\n            );\n\n            resultBoxes.forEach((box) => {\n              if (\n                !box.classList.contains("hidden") &&\n                !box.querySelector(".btn-share-auto")\n              ) {\n                const btn = document.createElement("button");\n                btn.className =\n                  "btn-share-auto mt-4 w-full bg-green-600 text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95";\n                btn.innerHTML = `<span>Compartir en WhatsApp</span>`;\n\n                btn.onclick = (event) => {\n                  event.preventDefault();\n                  const texto = box.innerText.split("Compartir")[0].trim();\n                  const msg = `📊 *Resultado en Chieffin*\\n\\n${texto}\\n\\n👉 ${window.location.href}`;\n                  window.open(\n                    `https://wa.me/?text=${encodeURIComponent(msg)}`,\n                    "_blank",\n                  );\n                };\n                box.appendChild(btn);\n              }\n            });\n          }, 200);\n        }\n      });\n    <\/script> </body> </html>'], ['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', '><link rel="canonical"', "><title>", ' | Chieffin</title><meta name="title"', '><meta name="description"', '><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="https://chieffin.com/og-image.jpg"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image" content="https://chieffin.com/og-image.jpg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#2563eb"><link rel="apple-touch-icon" href="/icon-192.png"><script type="application/ld+json">', '<\/script><script>\n      if ("serviceWorker" in navigator) {\n        window.addEventListener("load", () => {\n          navigator.serviceWorker.register("/sw.js");\n        });\n      }\n    <\/script>', '</head> <body class="bg-slate-50 text-slate-900 font-sans antialiased"> <header class="bg-white border-b border-slate-200 sticky top-0 z-50"> <nav class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4"> <a href="/" class="text-2xl font-black tracking-tight text-blue-600 shrink-0">\nCHIEFFIN<span class="text-slate-400">.com</span> </a> <div class="hidden lg:flex gap-4 text-sm font-medium text-slate-600"> ', ' </div> <div class="flex items-center gap-2"> <button id="favBtn" class="bg-slate-900 text-white px-3 py-2 sm:px-4 rounded-lg text-sm font-bold hover:bg-slate-800 transition flex items-center gap-2 shrink-0"> <span id="favIcon">⭐</span> <span class="hidden sm:inline">Favoritos</span> </button> ', ' </div> </nav> </header> <main class="min-h-[calc(100vh-160px)]"> ', " ", ' </main> <footer class="bg-white border-t border-slate-200 py-12 mt-20"></footer> <script>\n      let deferredPrompt;\n      const favBtn = document.getElementById("favBtn");\n      const favIcon = document.getElementById("favIcon");\n\n      const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);\n      const isiOS = /iPad|iPhone|iPod/.test(navigator.userAgent);\n\n      // --- Lógica de Instalación PWA ---\n      window.addEventListener("beforeinstallprompt", (e) => {\n        e.preventDefault();\n        deferredPrompt = e;\n        if (favBtn && favIcon) {\n          favIcon.textContent = "📲";\n          favBtn.innerHTML = "<span>📲</span> Instalar App";\n          favBtn.classList.replace("bg-slate-900", "bg-blue-600");\n        }\n      });\n\n      favBtn?.addEventListener("click", async () => {\n        if (deferredPrompt) {\n          deferredPrompt.prompt();\n          await deferredPrompt.userChoice;\n          deferredPrompt = null;\n          return;\n        }\n\n        if (isiOS) {\n          alert(\n            \'Para instalar en tu iPhone:\\\\n\\\\n1. Toca el botón "Compartir".\\\\n2. Selecciona "Agregar a inicio".\',\n          );\n          return;\n        }\n\n        const isMac = navigator.platform.toUpperCase().indexOf("MAC") >= 0;\n        alert(\n          isMobile\n            ? \'¡Guardanos en tu inicio! Tocá los tres puntos (⋮) y seleccioná "Instalar aplicación".\'\n            : \\`¡Guardanos en favoritos! Presioná \\${isMac ? "Cmd + D" : "Ctrl + D"}.\\`,\n        );\n      });\n\n      // --- Lógica del Botón de WhatsApp Automático ---\n      document.addEventListener("click", (e) => {\n        // Detectamos si el click fue en un botón de calcular\n        if (\n          e.target.innerText?.toLowerCase().includes("calcular") ||\n          e.target\n            .closest("button")\n            ?.innerText.toLowerCase()\n            .includes("calcular")\n        ) {\n          setTimeout(() => {\n            const resultBoxes = document.querySelectorAll(\n              \'[id*="res"], [id*="Result"], .animate-in\',\n            );\n\n            resultBoxes.forEach((box) => {\n              if (\n                !box.classList.contains("hidden") &&\n                !box.querySelector(".btn-share-auto")\n              ) {\n                const btn = document.createElement("button");\n                btn.className =\n                  "btn-share-auto mt-4 w-full bg-green-600 text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95";\n                btn.innerHTML = \\`<span>Compartir en WhatsApp</span>\\`;\n\n                btn.onclick = (event) => {\n                  event.preventDefault();\n                  const texto = box.innerText.split("Compartir")[0].trim();\n                  const msg = \\`📊 *Resultado en Chieffin*\\\\n\\\\n\\${texto}\\\\n\\\\n👉 \\${window.location.href}\\`;\n                  window.open(\n                    \\`https://wa.me/?text=\\${encodeURIComponent(msg)}\\`,\n                    "_blank",\n                  );\n                };\n                box.appendChild(btn);\n              }\n            });\n          }, 200);\n        }\n      });\n    <\/script> </body> </html>'])), addAttribute(Astro2.generator, "content"), addAttribute(`https://chieffin.com${Astro2.url.pathname}`, "href"), title, addAttribute(`${title} | Chieffin`, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), unescapeHTML(JSON.stringify({
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Chieffin",
    url: "https://chieffin.com",
    potentialAction: {
      "@type": "SearchAction",
      target: "https://chieffin.com/?q={search_term_string}",
      "query-input": "required name=search_term_string"
    }
  })), renderHead(), navigation.map((category) => renderTemplate`<div class="relative group"> <button class="flex items-center gap-1 hover:text-blue-600 transition py-5 font-bold whitespace-nowrap"> ${category.name} <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 text-slate-400 group-hover:text-blue-600 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path> </svg> </button> <div class="absolute left-0 mt-0 w-56 bg-white border border-slate-200 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-2 transition-all duration-200 z-[60]"> <div class="p-2 max-h-[70vh] overflow-y-auto"> ${category.links.map((link) => renderTemplate`<a${addAttribute(link.href, "href")} class="block px-4 py-2.5 text-sm text-slate-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition font-medium border-b border-slate-50 last:border-0"> ${link.name} </a>`)} </div> </div> </div>`), renderComponent($$result, "MenuMovil", $$MenuMovil, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "FAQ", $$FAQ, {}));
}, "C:/proyectos/seo-tools/src/layouts/Layout.astro", void 0);
const calculadoras = [
  {
    titulo: "IVA",
    ...
    icon: "IVA",
    color: "blue",
    keywords: "impuestos, afip, factura, monotributo, fiscal, debito, credito"
  },
  {
    titulo: "Porcentajes",
    ...
    icon: "%",
    color: "blue",
    keywords: "por ciento, proporcion, rebaja, aumento, regla de tres"
  },
  {
    titulo: "Préstamos",
    ...
    icon: "$",
    color: "indigo",
    keywords: "credito, banco, cuotas, hipoteca, prendario, plata, dinero"
  },
  // Cuando quieras subir la número 50, solo agregás un bloque acá.
  {
    ...
    keywords: "obra, remodelacion, latex, sintético, rodillo, metros cuadrados"
  },
  {
    titulo: "Edad Exacta",
    ...
    icon: "⏳",
    color: "emerald",
    keywords: "cumpleaños, nacimiento, tiempo, calendario, cuantos dias"
  },
  {
    ...
    icon: "⚡",
    color: "blue",
    keywords: "electricidad, factura, kwh, edenor, edesur, ahorro, energia"
  },
  {
    titulo: "Agua Diaria",
    ...
    icon: "💧",
    color: "blue",
    keywords: "hidratacion, salud, nutricion, litros, entrenamiento"
  },
  {
    ...
    icon: "✖️",
    color: "emerald",
    keywords: "proporcion, matematicas, x, despejar, calculo"
  },
  {
    ...
    icon: "⏱️",
    color: "blue",
    keywords: "tiempo, jornada laboral, fichaje, entrada, salida"
  },
  {
    titulo: "Círculo",
    ...
    icon: "⭕",
    color: "orange",
    keywords: "radio, diametro, pi, circunferencia, geometria"
  },
  {
    titulo: "Pitágoras",
    ...
    icon: "📐",
    color: "blue",
    keywords: "triangulo, hipotenusa, cateto, geometria, escuela"
  },
  {
    ...
    icon: "🔺",
    color: "orange",
    keywords: "superficie, base, altura, geometria, matematicas"
  },
  {
    ...
    icon: "⚖️",
    color: "indigo",
    keywords: "emprendedor, ventas, costos fijos, rentabilidad, negocios"
  },
  {
    ...
    icon: "📈",
    color: "emerald",
    keywords: "utilidad, beneficio, neto, bruto, comercio, ecommerce"
  },
  {
  ...
  },
  {
    ...
    icon: "🥩",
    color: "red",
    keywords: "parrilla, comida, amigos, carbon, vacio, chorizos, tira de asado"
  },
  {
    titulo: "Propinas",
    ...
    icon: "💸",
    color: "emerald",
    keywords: "mozo, restaurante, bar, servicio, atencion"
  },
  {
    titulo: "Descuentos",
    ...
    icon: "🏷️",
    color: "blue",
    keywords: "oferta, liquidacion, sale, promocion, barato"
  },
  {
    titulo: "Combustible",
    ...
    icon: "⛽",
    color: "orange",
    keywords: "nafta, diesel, gasoil, viaje, ruta, consumo auto"
  },
  {
    ...
    icon: "🏠",
    color: "blue",
    keywords: "vivienda, departamento, casa, credito hipotecario, inversion"
  },
  {
    ...
    icon: "📉",
    color: "red",
    keywords: "ipc, precios, economia, canasta basica, devaluacion"
  },
  {
    ...
    icon: "⚖️",
    color: "emerald",
    keywords: "indice masa corporal, nutricion, dieta, fitness, gordura"
  },
  {
    ...
    icon: "🔥",
    color: "orange",
    keywords: "calorias, metabolismo, tmb, ejercicio, adelgazar"
  },
  {
    ...
    icon: "🦾",
    color: "orange",
    keywords: "gym, gimnasio, musculo, proteinas, carbohidratos, grasa"
  },
  {
    ...
    icon: "🐾",
    color: "yellow",
    keywords: "perros, gatos, animal, veterinaria, años perro"
  },
  {
    ...
    icon: "🥩",
    color: "blue",
    keywords: "gym, entrenamiento, suplementos, dieta, nutricion"
  },
  {
    ...
    icon: "🌸",
    color: "pink",
    keywords: "fertilidad, periodo, regla, embarazo, mujer"
  },
  {
    ...
    icon: "👶",
    color: "indigo",
    keywords: "bebe, parto, gestacion, madre, obstetricia"
  },
  {
    titulo: "Macros Keto",
    ...
    icon: "🥑",
    color: "yellow",
    keywords: "cetogenica, dieta, grasa, sin carbohidratos, ayuno"
  },
  {
    titulo: "FC Máxima",
    ...
    icon: "❤️",
    color: "red",
    keywords: "corazon, pulsaciones, cardio, running, deporte"
  },
  {
    ...
    icon: "🚭",
    color: "emerald",
    keywords: "tabaco, pucho, cigarro, salud, ahorro"
  },
  {
    titulo: "Retiro FIRE",
    ...
    icon: "🏖️",
    color: "emerald",
    keywords: "jubilacion, libertad financiera, independencia, ahorro, inversion"
  },
  {
    ...
    icon: "💼",
    color: "indigo",
    keywords: "trabajo independiente, presupuesto, honorarios, servicios"
  },
  {
    titulo: "Dividir Cuenta",
    descripcion: "Calculá cuánto debe pagar cada uno en una cena grupal.",
    link: "/utiles/dividir-cuenta",
    icon: "🍽️",
    color: "indigo",
    keywords: "restaurante, amigos, pago, cena, vaquita"
  },
  {
    titulo: "Descuento Doble",
    descripcion: "Calculá el ahorro real cuando se aplican dos descuentos juntos.",
    link: "/utiles/descuento-doble",
    icon: "🏷️",
    color: "blue",
    keywords: "promocion, rebaja, tarjeta, banco, acumulado"
  },
  {
    titulo: "Costo por Uso",
    descripcion: "¿Vale la pena esa compra? Calculá cuánto te cuesta cada vez que lo usás.",
    link: "/utiles/costo-por-uso",
    icon: "🏷️",
    color: "emerald",
    keywords: "inversion, compra inteligente, ahorro, ropa, tecnologia"
  },
  {
    titulo: "Valor de tu Hora",
    descripcion: "Descubrí cuánto vale tu tiempo de trabajo realmente.",
    link: "/negocios/valor-hora",
    icon: "⏱️",
    color: "blue",
    keywords: "sueldo, jornada, productividad, salario"
  },
  {
    titulo: "Días Hábiles",
    descripcion: "Contá cuántos lunes a viernes hay entre dos fechas, excluyendo findes.",
    link: "/utiles/dias-habiles",
    icon: "🗓️",
    color: "blue",
    keywords: "calendario, feriados, trabajo, plazo, administrativo"
  },
  {
    titulo: "Dólar Tarjeta",
    descripcion: "Calculá el valor final de tus compras en el exterior con todos los impuestos.",
    link: "/finanzas/dolar-tarjeta",
    icon: "💳",
    color: "blue",
    keywords: "netflix, steam, spotify, exterior, impuestos, afip, pais"
  },
  {
    titulo: "Plazo Fijo",
    descripcion: "Calculá cuánto interés ganás por mes y el total al finalizar el periodo.",
    link: "/finanzas/plazo-fijo",
    icon: "🏦",
    color: "blue",
    keywords: "tna, tea, banco, ahorro, inversion, intereses"
  },
  {
    titulo: "Costo del Auto",
    descripcion: "Sumá seguro, patente, nafta y service para saber cuánto te cuesta tu auto por mes.",
    link: "/finanzas/costo-auto",
    icon: "🚗",
    color: "blue",
    keywords: "vehiculo, mantenimiento, cochera, gastos fijos"
  },
  {
    titulo: "Calculadora de Aguinaldo",
    descripcion: "Calculá tu SAC (Sueldo Anual Complementario) completo o proporcional.",
    link: "/finanzas/aguinaldo",
    icon: "💰",
    color: "emerald",
    keywords: "sac, sueldo, cobro, bono, junio, diciembre"
  },
  {
    titulo: "Indemnización",
    descripcion: "Calculá tu liquidación final estimada por despido sin causa.",
    link: "/finanzas/indemnizacion",
    icon: "⚖️",
    color: "red",
    keywords: "despido, renuncia, liquidacion, trabajo, abogado, justicia laboral"
  },
  {
    titulo: "Regla 50/30/20",
    descripcion: "Dividí tus ingresos para cubrir necesidades, gustos y ahorros.",
    link: "/finanzas/regla-50-30-20",
    icon: "📊",
    color: "emerald",
    keywords: "presupuesto, finanzas personales, ahorro, sueldo"
  },
  {
    titulo: "Vacaciones y Plus",
    descripcion: "Calculá cuántos días te corresponden y el plus salarial por tus vacaciones.",
    link: "/finanzas/vacaciones",
    icon: "🏖️",
    color: "blue",
    keywords: "descanso, trabajo, sueldo, dias de vacaciones, antiguedad"
  },
  {
    titulo: "Interés por Mora",
    descripcion: "Calculá el recargo por pago fuera de término de facturas o alquileres.",
    link: "/finanzas/interes-mora",
    icon: "📉",
    color: "red",
    keywords: "pago atrasado, multa, recargo, deuda, vencimiento"
  },
  {
    titulo: "Meta de Ahorro",
    descripcion: "Calculá cuánto tenés que ahorrar por mes para alcanzar tu próximo objetivo.",
    link: "/finanzas/meta-ahorro",
    icon: "🎯",
    color: "emerald",
    keywords: "objetivo, plata, ahorro mensual, comprar casa, auto"
  },
  {
    titulo: "Donaciones y Diezmo",
    descripcion: "Calculá el porcentaje de tus ingresos destinado a caridad o comunidad.",
    link: "/utiles/diezmo",
    icon: "🙏",
    color: "blue",
    keywords: "iglesia, caridad, ayuda, porcentaje, solidaridad"
  },
  {
    titulo: "Frigorías Aire",
    descripcion: "Calculá cuántas frigorías necesita tu aire acondicionado según el tamaño del ambiente.",
    link: "/hogar/aire-acondicionado",
    icon: "❄️",
    color: "blue",
    keywords: "frio, calor, climatizacion, btu, aire acondicionado, refrigeracion"
  },
  {
    titulo: "Cuotas con Interés",
    descripcion: "Calculá el valor de la cuota y el costo financiero total de tus compras.",
    link: "/finanzas/cuotas",
    icon: "💳",
    color: "indigo",
    keywords: "cft, interes, tarjeta, pago, cuotas fijas"
  },
  {
    titulo: "Comisiones de Venta",
    descripcion: "Calculá cuánto te queda neto después de las comisiones de plataformas de venta.",
    link: "/negocios/comisiones",
    icon: "🛒",
    color: "orange",
    keywords: "mercadolibre, pedidosya, rappi, ecommerce, ventas"
  },
  {
    titulo: "Markup vs Margen",
    descripcion: "Diferenciá cuánto le sumás al costo vs cuánto ganás realmente por cada venta.",
    link: "/negocios/markup-margen",
    icon: "📈",
    color: "indigo",
    keywords: "precio, ganancia, comercio, negocio"
  },
  {
    ...
    icon: "🧱",
    color: "orange",
    keywords: "obra, pared, construccion, materiales, cemento, albañil"
  },
  {
    ...
    icon: "💸",
    color: "red",
    keywords: "impuestos, afip, sueldo, salario, deducciones"
  },
  {
    ...
    icon: "🏗️",
    color: "slate",
    keywords: "mezcla, cemento, arena, piedra, construccion, cimiento, ormigon"
  },
  {
    ...
    icon: "⚡",
    color: "yellow",
    keywords: "factura, luz, watts, kwh, electrodomesticos"
  },
  {
  ...
  },
  {
    ...
    icon: "➗",
    color: "orange",
    keywords: "matematica, escuela, numerador, denominador"
  },
  {
    ...
    icon: "⏱️",
    color: "purple",
    keywords: "cronometro, suma horas, minutos, segundos"
  },
  {
  ...
  },
  {
    ...
    link: "/unidades/litros-a-galones",
    categoria: "unidades",
    icon: "🛢️",
    color: "indigo",
...
function getStaticPaths() {
  const categorias = [
    ...
    },
    {
      ...
      desc: "Calculá materiales para tu obra, consumo eléctrico y medidas para tu casa."
    },
    {
      id: "matematica",
      nombre: "Matemática y Geometría",
      desc: "Resolvé ecuaciones, calculá áreas y porcentajes de forma rápida."
    },
    {
      id: "negocios",
      nombre: "Negocios y Emprendedores",
      desc: "Calculadoras de rentabilidad, punto de equilibrio y gestión comercial."
    },
    {
      id: "salud",
      nombre: "Salud y Bienestar",
      desc: "Monitoreá tu IMC, gasto calórico y hábitos saludables."
    },
    {
      id: "varios",
      nombre: "Varios",
      desc: "Otras herramientas útiles para diversas situaciones."
    },
    {
      id: "unidades",
      nombre: "Unidades de Medida",
      desc: "Herramientas de conversión de unidades y más."
    },
    {
      id: "seo",
      nombre: "SEO",
      desc: "Herramientas para optimización de sitios web y estrategias de marketing digital."
    }
  ];
...
const $$categoria = createComponent(($$result, $$props, $$slots) => {
  ...
  const calcsFiltradas = calculadoras.filter(
    (calc) => calc.link.includes(`/${categoria}/`)
  );
...
Usar calculadora
<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7-7"></path> </svg> </div> </a>`)} </div> </div> ` })}`;

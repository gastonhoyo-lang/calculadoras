import { c as createAstro, a as createComponent, b as renderTemplate, u as unescapeHTML, e as addAttribute, m as maybeRenderHead, d as renderScript, r as renderComponent, f as renderSlot, g as renderHead } from './astro/server_Do9XiQ7L.mjs';
import 'piccolore';
import 'clsx';
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', '><link rel="canonical"', "><title>", ' | Chieffin</title><meta name="title"', '><meta name="description"', '><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="https://chieffin.com/og-image.jpg"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image" content="https://chieffin.com/og-image.jpg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#2563eb"><link rel="apple-touch-icon" href="/icon-192.png"><script type="application/ld+json">', '<\/script><script>\n      if ("serviceWorker" in navigator) {\n        window.addEventListener("load", () => {\n          navigator.serviceWorker.register("/sw.js");\n        });\n      }\n    <\/script>', '</head> <body class="bg-slate-50 text-slate-900 font-sans antialiased"> <header class="bg-white border-b border-slate-200 sticky top-0 z-50"> <nav class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4"> <a href="/" class="text-2xl font-black tracking-tight text-blue-600 shrink-0">\nCHIEFFIN<span class="text-slate-400">.com</span> </a> <div class="hidden lg:flex gap-4 text-sm font-medium text-slate-600"> ', ' </div> <div class="flex items-center gap-2"> <button id="favBtn" class="bg-slate-900 text-white px-3 py-2 sm:px-4 rounded-lg text-sm font-bold hover:bg-slate-800 transition flex items-center gap-2 shrink-0"> <span id="favIcon">\u2B50</span> <span class="hidden sm:inline">Favoritos</span> </button> ', ' </div> </nav> </header> <main class="min-h-[calc(100vh-160px)]"> ', " ", ' </main> <footer class="bg-white border-t border-slate-200 py-12 mt-20"> <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-slate-500"> <div> <p class="font-bold text-lg mb-4 text-slate-900">Chieffin</p> <p>\nHerramientas dise\xF1adas para ayudarte a entender mejor tus n\xFAmeros y\n            tomar decisiones informadas.\n</p> </div> <div> <p class="font-bold mb-4 text-slate-900">Categor\xEDas Populares</p> <ul class="space-y-2"> <li> <a href="/finanzas/prestamo" class="hover:text-blue-600">Pr\xE9stamos</a> </li> <li> <a href="/finanzas/interes-compuesto" class="hover:text-blue-600">Inter\xE9s Compuesto</a> </li> <li> <a href="/hogar/hormigon" class="hover:text-blue-600">Construcci\xF3n</a> </li> </ul> </div> <div> <p class="font-bold mb-4 text-slate-900">Legal y Ayuda</p> <ul class="space-y-2"> <li> <a href="/privacidad" class="hover:text-blue-600">Pol\xEDtica de Privacidad</a> </li> <li> <a href="/contacto" class="hover:text-blue-600">Contacto y Sugerencias</a> </li> </ul> </div> </div> <div class="max-w-6xl mx-auto px-4 mt-12 pt-8 border-t border-slate-100 text-center text-slate-400 text-xs">\n&copy; ', ` Chieffin.com - Herramientas gratuitas para
      ...
      window.addEventListener("beforeinstallprompt", (e) => {
        ...
        deferredPrompt = e;
        if (favBtn && favIcon) {
          favIcon.textContent = "\u{1F4F2}";
          favBtn.innerHTML = "<span>\u{1F4F2}</span> Instalar App";
      ...
      favBtn?.addEventListener("click", async () => {
        ...
        if (isiOS) {
          alert(
            'Para instalar en tu iPhone:\\n\\n1. Toca el bot\xF3n "Compartir" (cuadrado con flecha).\\n2. Selecciona "Agregar a inicio".',
          );
          return;
        }
        ...
        if (isMobile) {
          alert(
            '\xA1Guardanos en tu inicio!\\n\\nToc\xE1 los tres puntos (\u22EE) y seleccion\xE1 "Instalar aplicaci\xF3n" o "Agregar a pantalla de inicio".',
          );
          return;
        }
        ...
        alert(
          \`\xA1Guardanos en tus favoritos!\\n\\nPresion\xE1 \${isMac ? "Cmd + D" : "Ctrl + D"} para tenernos a mano.\`,
        );
      <script is:inline>
  // Esta funci\xF3n se ejecuta cada vez que el usuario hace clic en un bot\xF3n de calcular
  document.addEventListener('click', (e) => {
    // Si el clic fue en un bot\xF3n de "Calcular" (buscamos por ID o clase)
    if (e.target.id?.includes('btn') || e.target.innerText.toLowerCase().includes('calcular')) {
      
      // Esperamos un milisegundo a que tus scripts actuales muestren el resultado
      setTimeout(() => {
        const resultBoxes = document.querySelectorAll('[id*="res"], [id*="Result"], .animate-in');
        
        resultBoxes.forEach(box => {
          if (!box.classList.contains('hidden') && !box.querySelector('.btn-share-auto')) {
            // Creamos el bot\xF3n din\xE1micamente
            const btn = document.createElement('button');
            btn.className = "btn-share-auto mt-4 w-full bg-green-600 text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95";
            btn.innerHTML = \`<span>Compartir en WhatsApp</span>\`;
            
            btn.onclick = () => {
              const texto = box.innerText.replace(/[\\n\\r]+/g, '\\n').trim();
              const msg = \`\u{1F4CA} *Resultado de Chieffin*\\n\\n\${texto}\\n\\n\u{1F449} \${window.location.href}\`;
...
</body> </html> `], ['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', '><link rel="canonical"', "><title>", ' | Chieffin</title><meta name="title"', '><meta name="description"', '><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image" content="https://chieffin.com/og-image.jpg"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image" content="https://chieffin.com/og-image.jpg"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#2563eb"><link rel="apple-touch-icon" href="/icon-192.png"><script type="application/ld+json">', '<\/script><script>\n      if ("serviceWorker" in navigator) {\n        window.addEventListener("load", () => {\n          navigator.serviceWorker.register("/sw.js");\n        });\n      }\n    <\/script>', '</head> <body class="bg-slate-50 text-slate-900 font-sans antialiased"> <header class="bg-white border-b border-slate-200 sticky top-0 z-50"> <nav class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4"> <a href="/" class="text-2xl font-black tracking-tight text-blue-600 shrink-0">\nCHIEFFIN<span class="text-slate-400">.com</span> </a> <div class="hidden lg:flex gap-4 text-sm font-medium text-slate-600"> ', ' </div> <div class="flex items-center gap-2"> <button id="favBtn" class="bg-slate-900 text-white px-3 py-2 sm:px-4 rounded-lg text-sm font-bold hover:bg-slate-800 transition flex items-center gap-2 shrink-0"> <span id="favIcon">\u2B50</span> <span class="hidden sm:inline">Favoritos</span> </button> ', ' </div> </nav> </header> <main class="min-h-[calc(100vh-160px)]"> ', " ", ' </main> <footer class="bg-white border-t border-slate-200 py-12 mt-20"> <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-slate-500"> <div> <p class="font-bold text-lg mb-4 text-slate-900">Chieffin</p> <p>\nHerramientas dise\xF1adas para ayudarte a entender mejor tus n\xFAmeros y\n            tomar decisiones informadas.\n</p> </div> <div> <p class="font-bold mb-4 text-slate-900">Categor\xEDas Populares</p> <ul class="space-y-2"> <li> <a href="/finanzas/prestamo" class="hover:text-blue-600">Pr\xE9stamos</a> </li> <li> <a href="/finanzas/interes-compuesto" class="hover:text-blue-600">Inter\xE9s Compuesto</a> </li> <li> <a href="/hogar/hormigon" class="hover:text-blue-600">Construcci\xF3n</a> </li> </ul> </div> <div> <p class="font-bold mb-4 text-slate-900">Legal y Ayuda</p> <ul class="space-y-2"> <li> <a href="/privacidad" class="hover:text-blue-600">Pol\xEDtica de Privacidad</a> </li> <li> <a href="/contacto" class="hover:text-blue-600">Contacto y Sugerencias</a> </li> </ul> </div> </div> <div class="max-w-6xl mx-auto px-4 mt-12 pt-8 border-t border-slate-100 text-center text-slate-400 text-xs">\n&copy; ', ` Chieffin.com - Herramientas gratuitas para
        uso cotidiano.
</div> </footer> <script>
      let deferredPrompt;
      const favBtn = document.getElementById("favBtn");
...
</body> </html> `])), addAttribute(Astro2.generator, "content"), addAttribute(canonicalURL, "href"), title, addAttribute(`${title} | Chieffin`, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), unescapeHTML(JSON.stringify({
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Chieffin",

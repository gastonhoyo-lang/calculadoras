...
const $$CalculadoraProporcion = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Proporciones Online | Hallar la Inc\xF3gnita X", "description": "Resolv\xE9 proporciones matem\xE1ticas al instante. Ideal para escalado de im\xE1genes, razones y proporciones directas." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

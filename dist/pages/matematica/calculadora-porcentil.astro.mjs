...
const $$CalculadoraPorcentil = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Percentiles Online | Estad\xEDstica F\xE1cil", "description": "Calcul\xE1 el percentil de un conjunto de datos de forma r\xE1pida. Herramienta ideal para an\xE1lisis de datos, educaci\xF3n y salud." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

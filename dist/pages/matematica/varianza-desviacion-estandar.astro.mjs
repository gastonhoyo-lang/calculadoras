...
const $$VarianzaDesviacionEstandar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Varianza y Desviaci\xF3n Est\xE1ndar | Chieffin", "description": "Calcul\xE1 la dispersi\xF3n de tus datos de forma f\xE1cil. Incluye ejemplos paso a paso de varianza poblacional y muestral." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4">

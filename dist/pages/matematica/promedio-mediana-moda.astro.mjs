...
const $$PromedioMedianaModa = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Promedio, Mediana y Moda | Estad\xEDstica B\xE1sica", "description": "Calcul\xE1 la media, mediana y moda de un conjunto de n\xFAmeros. Incluye ejemplos paso a paso y explicaci\xF3n de cada medida de tendencia central." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4">

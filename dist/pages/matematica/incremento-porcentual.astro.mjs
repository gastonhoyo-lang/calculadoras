...
const $$IncrementoPorcentual = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Incremento Porcentual | Medir Crecimiento Online", "description": "Calcul\xE1 la diferencia porcentual entre dos valores. Ideal para m\xE9tricas SEO, finanzas y estad\xEDsticas de crecimiento." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

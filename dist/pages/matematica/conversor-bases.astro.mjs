...
const $$ConversorBases = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Conversor de Bases Num\xE9ricas | Binario, Decimal, Hex", "description": "Convert\xED n\xFAmeros entre diferentes bases: binario, octal, decimal y hexadecimal de forma instant\xE1nea." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

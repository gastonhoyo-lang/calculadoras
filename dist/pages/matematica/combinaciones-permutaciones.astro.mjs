...
const $$CombinacionesPermutaciones = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Combinaciones y Permutaciones (nCr y nPr) | Paso a Paso", "description": "Calcul\xE1 f\xE1cilmente combinaciones y permutaciones. Incluye f\xF3rmulas, ejemplos y explicaci\xF3n de cu\xE1ndo importa el orden." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

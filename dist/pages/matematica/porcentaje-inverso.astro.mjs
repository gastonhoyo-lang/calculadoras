...
const $$PorcentajeInverso = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Porcentaje Inverso | Hallar Valor Original", "description": "Calcul\xE1 el valor inicial de un n\xFAmero antes de aplicarle un aumento o descuento porcentual. Herramienta gratuita y precisa." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Porcentaje Inverso

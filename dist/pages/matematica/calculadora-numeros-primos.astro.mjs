...
const $$CalculadoraNumerosPrimos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de N\xFAmeros Primos Online | Test de Primalidad", "description": "Verific\xE1 si un n\xFAmero es primo o compuesto al instante. Incluye buscador del siguiente n\xFAmero primo y explicaci\xF3n detallada." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

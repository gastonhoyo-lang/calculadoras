...
const $$CalculadoraDivisores = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Divisores de un N\xFAmero | Lista Completa", "description": "Calcul\xE1 todos los divisores de cualquier n\xFAmero entero. Descubr\xED si un n\xFAmero es primo y cu\xE1ntos divisores exactos tiene." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

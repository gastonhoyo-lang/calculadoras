...
const $$Areas = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de \xC1reas | Calcular Metros Cuadrados (m2) | Chieffin", "description": "Calcul\xE1 la superficie de cualquier espacio rectangular o cuadrado. Herramienta f\xE1cil para medir paredes, pisos y terrenos con ejemplos paso a paso." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Matemáticas Prácticas</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">

...
const $$CalculadoraDeVolumenes = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Vol\xFAmenes | Metros C\xFAbicos (m3) y Litros | Chieffin", "description": "Calcul\xE1 el volumen de piletas, tanques y habitaciones. Obten\xE9 el resultado en metros c\xFAbicos y litros de forma instant\xE1nea." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-cyan-100 text-cyan-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Matemáticas y Construcción</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">

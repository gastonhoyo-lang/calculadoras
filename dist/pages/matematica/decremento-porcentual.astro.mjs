...
const $$DecrementoPorcentual = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Decremento Porcentual | Medir Ca\xEDdas y Descuentos", "description": "Calcul\xE1 la disminuci\xF3n porcentual entre dos valores. Herramienta ideal para medir p\xE9rdidas de tr\xE1fico SEO o rebajas de precios." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

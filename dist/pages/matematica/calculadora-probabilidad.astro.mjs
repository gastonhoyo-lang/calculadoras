...
const $$CalculadoraProbabilidad = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Probabilidad Simple | Calcular Posibilidades Online", "description": "Calcul\xE1 la probabilidad de que ocurra un evento. Herramienta f\xE1cil para determinar casos favorables sobre casos posibles." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

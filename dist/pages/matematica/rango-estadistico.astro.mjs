...
const $$RangoEstadistico = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Rango Estad\xEDstico Online | Amplitud de Datos", "description": "Calcul\xE1 el rango de un conjunto de datos al instante. Descubr\xED la diferencia entre el valor m\xE1ximo y el m\xEDnimo de tu muestra." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Rango Estadístico

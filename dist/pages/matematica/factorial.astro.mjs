...
const $$Factorial = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Factorial Online (n!) | Paso a Paso", "description": "Calcul\xE1 el factorial de cualquier n\xFAmero entero positivo. Incluye la f\xF3rmula explicada y el procedimiento detallado." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

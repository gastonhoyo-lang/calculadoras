...
const $$EcuacionesSegundoGrado = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Ecuaciones de Segundo Grado | Paso a Paso", "description": "Resolv\xE9 ecuaciones cuadr\xE1ticas usando la f\xF3rmula de Bhaskara. Incluye ejemplos resueltos y explicaci\xF3n del discriminante." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4">

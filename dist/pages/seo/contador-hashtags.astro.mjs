...
const $$ContadorHashtags = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contador de Hashtags | Optimizador de Redes Sociales", "description": "Extra\xE9 y cont\xE1 hashtags de tu contenido. Asegur\xE1 la cantidad ideal para Instagram, LinkedIn y Twitter sin caer en el spam." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

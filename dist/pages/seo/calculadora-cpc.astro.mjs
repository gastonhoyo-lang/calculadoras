...
const $$CalculadoraCpc = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de CPC Online | Control\xE1 tu Gasto en Publicidad", "description": "Calcul\xE1 el Costo por Clic (CPC) de tus campa\xF1as de anuncios. Optimiz\xE1 tu presupuesto de Google Ads y Facebook Ads con datos reales." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Calculadora de CPC

...
const $$AnalizadorRepeticion = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Analizador de Repetici\xF3n de Palabras | Mejora tu Redacci\xF3n SEO", "description": "Detect\xE1 palabras repetidas en tu texto y mejor\xE1 la fluidez de tu contenido. Herramienta gratuita para escritores y expertos en SEO." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$CalculadoraAlcance = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Alcance en Redes Sociales | Reach SEO Tool", "description": "Med\xED el alcance \xFAnico de tus publicaciones. Descubr\xED qu\xE9 porcentaje de tus seguidores te ve y cu\xE1nta gente nueva est\xE1s alcanzando." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

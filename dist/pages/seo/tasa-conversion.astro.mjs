...
const $$TasaConversion = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Tasa de Conversi\xF3n (CR) | Optimizaci\xF3n SEO", "description": "Calcul\xE1 el porcentaje de conversi\xF3n de tu sitio web. Analiz\xE1 cu\xE1ntos visitantes se transforman en clientes y mejor\xE1 tu estrategia de marketing." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$ContadorEncabezados = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contador de Encabezados H1, H2, H3 | Auditor\xEDa de Estructura SEO", "description": "Analiz\xE1 la jerarqu\xEDa de etiquetas de encabezado de tu contenido. Asegur\xE1 una estructura H1-H6 perfecta para mejorar el posicionamiento en buscadores." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$GeneradorSlug = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Generador de Slugs SEO | Crear URLs Amigables Online", "description": "Convert\xED cualquier t\xEDtulo en una URL limpia y optimizada para SEO. Elimin\xE1 tildes, caracteres especiales y espacios autom\xE1ticamente." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$RadioTextoHtml = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Ratio Texto-HTML | Auditor\xEDa de SEO T\xE9cnico", "description": "Calcul\xE1 la proporci\xF3n de texto frente al c\xF3digo HTML de tu p\xE1gina. Optimiz\xE1 el peso de tu web y mejor\xE1 la relevancia para los buscadores." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Ratio Texto-HTML

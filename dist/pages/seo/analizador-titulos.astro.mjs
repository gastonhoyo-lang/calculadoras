...
const $$AnalizadorTitulos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Analizador de T\xEDtulos SEO | Optimiz\xE1 tu Click-Through Rate", "description": "Analiz\xE1 tus t\xEDtulos para Google. Evalu\xE1 la longitud, el sentimiento y la efectividad de tus encabezados para atraer m\xE1s clics." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

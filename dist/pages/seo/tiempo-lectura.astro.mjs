...
const $$TiempoLectura = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Tiempo de Lectura | Estimaci\xF3n para Blogs y SEO", "description": "Calcul\xE1 cu\xE1nto tardar\xE1 un usuario en leer tu contenido. Optimiz\xE1 la experiencia de usuario (UX) de tu blog con tiempos precisos." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$RoiMarketing = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de ROI Marketing | Med\xED tu Rentabilidad", "description": "Calcul\xE1 el Retorno de Inversi\xF3n (ROI) de tus campa\xF1as de marketing y publicidad. Descubr\xED si tus estrategias SEO y SEM son rentables." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

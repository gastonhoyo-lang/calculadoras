...
const $$LongitudMetaDescription = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Longitud de Meta Description | SEO Snippet Tool", "description": "Asegur\xE1 que tus meta descripciones no se corten en Google. Calcul\xE1 la longitud ideal y optimiz\xE1 tu CTR con nuestra herramienta gratuita." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

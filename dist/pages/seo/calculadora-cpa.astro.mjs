...
const $$CalculadoraCpa = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de CPA | Costo por Adquisici\xF3n de Clientes", "description": "Calcul\xE1 tu Costo por Adquisici\xF3n (CPA) de forma exacta. Med\xED cu\xE1nto te cuesta cada venta y optimiz\xE1 la rentabilidad de tu negocio." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Calculadora de CPA

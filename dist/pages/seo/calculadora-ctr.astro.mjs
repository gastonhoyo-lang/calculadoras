...
const $$CalculadoraCtr = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de CTR SEO | Analiz\xE1 tu Tasa de Clics", "description": "Calcul\xE1 el CTR de tus campa\xF1as y resultados de b\xFAsqueda. Aprend\xE9 a optimizar tus Meta T\xEDtulos para atraer m\xE1s clics en Google." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Calculadora de CTR

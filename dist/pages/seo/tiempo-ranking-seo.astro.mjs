...
const $$TiempoRankingSeo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Tiempo de Ranking SEO | Estimaci\xF3n de Posicionamiento", "description": "\xBFCu\xE1nto tarda en posicionar una web? Calcul\xE1 el tiempo estimado para llegar a la primera p\xE1gina de Google seg\xFAn tu competencia y autoridad." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$CalculadoraCpl = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de CPL | Costo por Lead en Marketing Digital", "description": "Calcul\xE1 tu Costo por Lead (CPL) de forma r\xE1pida. Med\xED la eficiencia de tus campa\xF1as de captaci\xF3n y optimiz\xE1 tu embudo de ventas." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

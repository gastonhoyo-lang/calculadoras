...
const $$EngagementRate = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Engagement Rate | Med\xED tu Impacto en Redes", "description": "Calcul\xE1 la tasa de interacci\xF3n de tus publicaciones en Instagram, LinkedIn o TikTok. Analiz\xE1 el compromiso real de tu audiencia." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$ContadorCaracteresSinEspacios = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contador de Caracteres sin Espacios | Herramienta de Conteo Neto", "description": "Cont\xE1 caracteres excluyendo espacios en blanco autom\xE1ticamente. Ideal para l\xEDmites de texto acad\xE9micos y t\xE9cnicos." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

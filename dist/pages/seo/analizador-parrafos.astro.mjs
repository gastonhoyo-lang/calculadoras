...
const $$AnalizadorParrafos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Analizador de Longitud de P\xE1rrafos | SEO Copywriting Tool", "description": "Audit\xE1 la legibilidad de tu contenido. Detect\xE1 p\xE1rrafos demasiado largos que afectan la experiencia de usuario y el SEO de tu p\xE1gina." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

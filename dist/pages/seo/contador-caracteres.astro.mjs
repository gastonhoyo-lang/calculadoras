...
const $$ContadorCaracteres = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contador de Caracteres SEO | Simulador de Google", "description": "Valid\xE1 la longitud de tus Meta T\xEDtulos y Meta Descripciones. Evit\xE1 que Google recorte tu contenido en los resultados de b\xFAsqueda." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

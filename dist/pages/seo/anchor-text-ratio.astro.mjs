...
const $$AnchorTextRatio = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Anchor Text Ratio | Auditor\xEDa de Perfil de Enlaces", "description": "Analiz\xE1 la distribuci\xF3n de tus textos de ancla. Evit\xE1 penalizaciones de Google por sobreoptimizaci\xF3n y manten\xE9 un perfil de enlaces natural." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

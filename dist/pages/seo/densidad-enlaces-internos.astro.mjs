...
const $$DensidadEnlacesInternos = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Densidad de Enlaces Internos | SEO On-Page", "description": "Analiz\xE1 la proporci\xF3n de links internos en tu contenido. Maximiz\xE1 el flujo de autoridad (Link Juice) y mejor\xE1 la navegaci\xF3n de tu sitio." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

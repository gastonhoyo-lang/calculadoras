...
const $$ReglaDel72 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora Regla del 72 | Duplicar tu Inversi\xF3n", "description": "Calcul\xE1 cu\xE1nto tiempo tardar\xE1 tu dinero en duplicarse con el inter\xE9s compuesto. La regla del 72 es la herramienta m\xE1s r\xE1pida para inversores." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Regla del 72

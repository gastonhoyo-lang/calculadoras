...
const $$PerdidaPoderAdquisitivo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de P\xE9rdida de Poder Adquisitivo | Valor del Dinero", "description": "Calcul\xE1 cu\xE1nto valor perdi\xF3 tu dinero debido a la inflaci\xF3n. Descubr\xED cu\xE1nto valen hoy tus ahorros o tu sueldo comparado con el pasado." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

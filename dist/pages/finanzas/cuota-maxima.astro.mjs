...
const $$CuotaMaxima = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Cuota M\xE1xima de Pr\xE9stamo | Salud Financiera", "description": "Calcul\xE1 cu\xE1nto pod\xE9s pagar de cuota mensual sin comprometer tus finanzas. Basado en la regla del 30% de ingresos netos." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">

...
const $$TasasTnaTea = createComponent(($$result, $$props, $$slots) => {
  ...
  const description = "Convert\xED Tasa Nominal Anual (TNA) a Tasa Efectiva Anual (TEA) y viceversa. Calcul\xE1 el rendimiento real de tus inversiones y pr\xE9stamos.";

...
const $$Descuento = createComponent(($$result, $$props, $$slots) => {
...
Total a pagar
</p> <div id="totalConPropina" class="text-xl font-bold">$0</div> </div> </div> </div> ${renderScript($$result2, "C:/proyectos/seo-tools/src/pages/utiles/descuento.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/proyectos/seo-tools/src/pages/utiles/descuento.astro", void 0);

const $$file = "C:/proyectos/seo-tools/src/pages/utiles/descuento.astro";
const $$url = "/utiles/descuento";
